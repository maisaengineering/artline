...
new_field = function(element){
    ...
    if($val=='add') {
        ...
        $(element).replaceWith('<input type="text" name="project[item_list][][' + $class_name + ']" id="project_item_list__'+ $class_name +'" class="form-control" placeholder="'+ place_holder +'"  required="required">')
    }
}
